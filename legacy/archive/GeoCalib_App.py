...
class GeoCalibApp(QMainWindow):
    ...
    Implements a single-view workflow: TOA extraction → Geometry solving → Alignment & Export.
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Acoustic Array Geometry Processing App")
    ...
    def create_left_panel(self):
        """Create control panel on the left - Simplified Single View"""
        # Main container with scroll area
        scroll_area = QScrollArea()
        scroll_area.setWidgetResizable(True)
        
        # Widget to hold all content
        content_widget = QWidget()
        content_layout = QVBoxLayout()
        
        # Add sections sequentially
        content_layout.addWidget(self.create_toa_processing_section())
        content_layout.addWidget(self.create_geometry_section())
        content_layout.addWidget(self.create_alignment_section())
        content_layout.addWidget(self.create_visualization_section())
        ...
        # Wrap in a group box for consistency with previous layout
        group = QGroupBox("Processing Workflow")
    ...
    def create_geometry_section(self):
        ...
        group = QGroupBox("Step 2: Array Geometry Inference")
        group.setStyleSheet("QGroupBox { font-weight: bold; }")
        layout = QVBoxLayout()
        ...
        self.max_iter_spin.setValue(20000)
